...
class LoginPagePanitia extends StatefulWidget {
  const LoginPagePanitia({super.key});

  @override
  State<LoginPagePanitia> createState() => _LoginPagePanitiaState();
}

class _LoginPagePanitiaState extends State<LoginPagePanitia> {
  String selectedRole = "Panitia";
          ...
          child: Column(
            ...
            children: [
              ...
              PrimaryButton(
                ...
                onPressed: () {
                  setState(() {
                    showEmailError = emailController.text != "12345";
                    showPasswordError =
